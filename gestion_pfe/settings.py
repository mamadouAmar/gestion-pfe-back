"""
Django settings for gestion_pfe project.
...
SECRET_KEY = 'django-insecure-&43ztzxe0ntm*9jr(x*2r3*o6=vks$g_bf$m*iw%owuz&&74#e'
...
WSGI_APPLICATION = 'gestion_pfe.wsgi.application'
